...
SUBJECT="sub-00012"
SESSION="ses-sub00012umich750MR202501151"
ACQ="product"
RUN="01"

BIDS_DIR="/home/jon/fmriprep/data"
DERIVATIVES_ROOT="${BIDS_DIR}/derivatives/minimal"
WORK_ROOT="/home/jon/fmriprep/work/minimal"
...
# ----------------------------------------------------------------------
# Public derivative directories and working directory
# ----------------------------------------------------------------------

DERIVATIVE_STEM="${SUBJECT}_${SESSION}_task-rest_acq-${ACQ}_run-${RUN}"

SUBJECT_DERIV_DIR="${DERIVATIVES_ROOT}/${SUBJECT}/${SESSION}"
FUNC_DIR="${SUBJECT_DERIV_DIR}/func"
FMAP_DIR="${SUBJECT_DERIV_DIR}/fmap"
ANAT_DIR="${SUBJECT_DERIV_DIR}/anat"
QC_DIR="${SUBJECT_DERIV_DIR}/qc"
...
T1_BRAIN="${WORK_DIR}/${SUBJECT}_desc-brain_T1w"
T1_FAST_PREFIX="${WORK_DIR}/${SUBJECT}_fast"
...
# Copy motion diagnostics into the public QC directory.
